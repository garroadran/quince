...
class TestSetentaCounter(unittest.TestCase):
    def test_compare(self):
        pc = SetentaCounter()
        a_hand = [Card(5, 'oro'), Card(6, 'basto'), Card(4, 'espada'), Card(6,'copa')]
        b_hand = [Card(2, 'oro'), Card(2, 'basto'), Card(5, 'espada'), Card(2,'copa')]
        c_hand = [Card(6, 'oro'), Card(1, 'basto'), Card(6, 'espada'), Card(7,'copa')]
    ...
    def test_four_suits_required(self):
        ...
        b_hand = [Card(2, 'oro'), Card(2, 'basto'), Card(2, 'espada'), Card(2,'copa')]
